...
/*Question  No 2*/ 
/*--------------------------------------------*/
/*let subject : string = 'Hello Eric, would you like to learn some Python today?' 
...
/*let Person_Name : string = 'Muhammad  Ali';
...
/*
let Guest_list : string[] = ["Zaid","Mahid","Mahad"]



Guest_list.unshift('Waqar'); //print on 0 index
Guest_list.splice(Math.floor(Guest_list.length / 2),0,"Zain"); // print on 2 index 
...
/*--------------------------------------------*/
/*
let Guest_list : string[] = ["Waqar","Zaid","Zain","Mahid","Mahad","Danish"]
...
{
let remove_guest = Guest_list.pop(); //delete guest 
...
console.log('Update Guest List' , Guest_list)
*/
/*--------------------------------------------*/
...
let languages : string[] = ['C#', 'python', 'typescript', 'ruby']
...
Shirts('Large','I love TypeScript')
Shirts('Medium','I love TypeScript')
Shirts('Samll','I love C#')
*/
/*--------------------------------------------*/
...
/*--------------------------------------------*/
/* 
function show_magicin(magic:string[]) {
...
function great_magicin(magic:string[]) : string[] {
...
let Magicians : string[] = ["david","jhon"]
let great_magicians : string[] = great_magicin(Magicians)
show_magicin(Magicians);

show_magicin(great_magicians);
*/
/*--------------------------------------------*/
